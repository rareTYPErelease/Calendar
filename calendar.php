...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1> 
                <?php 
                    echo "<br><b>BRUIN FAMILY SCHEDULE </b><br>";
            ...
            <tr>    
                <th class='hr_td'></th>
                <th class='table_header'>&nbsp&nbsp&nbsp&nbsp&nbspJOE</th> 
                <th class='table_header'>&nbsp&nbsp&nbsp&nbsp&nbspJOANA</th>
                <th class='table_header'>&nbsp&nbspLILCUB</th>
            </tr> 
            <tr> <br> </tr>
